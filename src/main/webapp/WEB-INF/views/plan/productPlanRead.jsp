			...
			<tr>
				...
				<td>
					<input class="easyui-datebox" type="text" name="cgyj.actualFinishTime"
						   value="<fmt:formatDate value="${cgyj.actualFinishTime}" type="date" dateStyle="medium"/>"disabled="disabled" />
				</td>
				<td>
					<input class="easyui-textbox" type="text" name="cgyj.nodeLeader" value="${cgyj.nodeLeader }" disabled="disabled"/>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input class="easyui-datebox" type="text" name="cggt.actualFinishTime"
						   value="<fmt:formatDate value="${cggt.actualFinishTime}" type="date" dateStyle="medium"/>" disabled="disabled"/>
				</td>
				<td>
					<input class="easyui-textbox" type="text" name="cggt.nodeLeader" value="${cggt.nodeLeader }" disabled="disabled"/>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input class="easyui-datebox" type="text" name="yjff.actualFinishTime"
						   value="<fmt:formatDate value="${yjff.actualFinishTime}" type="date" dateStyle="medium"/>" disabled="disabled"/>
				</td>
				<td>
					<input class="easyui-textbox" type="text" name="yjff.nodeLeader" value="${yjff.nodeLeader }" disabled="disabled"/>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input class="easyui-datebox" type="text" name="zp.actualFinishTime"
						   value="<fmt:formatDate value="${zp.actualFinishTime}" type="date" dateStyle="medium"/>" disabled="disabled"/>
				</td>
				<td>
					<input class="easyui-textbox" type="text" name="zp.nodeLeader" value="${zp.nodeLeader }" disabled="disabled" />
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input class="easyui-datebox" type="text" name="jy.actualFinishTime"
						   value="<fmt:formatDate value="${jy.actualFinishTime}" type="date" dateStyle="medium"/>" disabled="disabled"/>
				</td>
				<td>
					<input class="easyui-textbox" type="text" name="jy.nodeLeader" value="${jy.nodeLeader }" disabled="disabled" />
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input class="easyui-datebox" type="text" name="ts.actualFinishTime"
						   value="<fmt:formatDate value="${ts.actualFinishTime}" type="date" dateStyle="medium"/>" disabled="disabled"/>
				</td>
				<td>
					<input class="easyui-textbox" type="text" name="ts.nodeLeader" value="${ts.nodeLeader }" disabled="disabled"/>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input class="easyui-datebox" type="text" name="rk.actualFinishTime"
						   value="<fmt:formatDate value="${rk.actualFinishTime}" type="date" dateStyle="medium"/>" disabled="disabled"/>
				</td>
				<td>
					<input class="easyui-textbox" type="text" name="rk.nodeLeader" value="${rk.nodeLeader }" disabled="disabled"/>
				</td>
				<td>
