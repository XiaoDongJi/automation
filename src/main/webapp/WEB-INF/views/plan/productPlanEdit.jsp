...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	    	...
	    	<div style="margin-left: 10px;margin-top: 20px;">
		    	<table class="tb_basic" style="width: 95%;">
		    		...
		    		<tr>
		    			...
		    			<td>产品种类:</td>
		    			<td>
	    					<select class="easyui-combobox" id="productType" name="productType">
		    			...
		    			<td>订货单位:</td>
		    			<td>
		    				<select class="easyui-combobox" id="orderCompany" name="orderCompany">
		    		...
		    		<tr>
		    			...
		    			<td>设计部门:</td>
		    			<td>
		    				<select class="easyui-combobox" id="designCompany" name="designCompany">
		    					<option value="1">自动化</option>
		    			...
		    			<td>编制:</td>
		    			<td>
		    				<select class="easyui-combobox" id="organizer" name="organizer">
		    		...
		    		<tr>
		    			<td>批准:</td>
		    			<td>
		    				<select class="easyui-combobox" id="approver" name="approver">
		    		...
		    		<tr>
		    			...
		    			<td>重要程度:</td>
		    			<td>
		    				<select class="easyui-combobox" id="importanceDegree" name="importanceDegree">
		    		...
		    		<tr>
		    			...
		    			<td>状态:</td>
		    			<td>
		    				<select class="easyui-combobox" id="projectStatus" name="projectStatus" style="width: 145px;">
		    			...
		    			<tr>
		    				...
		    				<td>
			    				...
			    				<input class="easyui-datebox" type="text" name="cgyj.planFinishTime" 
			    					value="<fmt:formatDate value="${cgyj.planFinishTime}" type="date" dateStyle="medium"/>"/>
		    				</td>
		    				<td>
		    					<input class="easyui-numberbox" maxlength="3" type="text" name="cgyj.planDayNum"
		    						value="${cgyj.planDayNum }" data-options="min:0,max:1000,precision:0"/>
		    				</td>
		    				<td>
		    			...
		    			<tr>
		    				...
		    				<td>
			    				...
			    				<input class="easyui-datebox" type="text" name="cggt.planFinishTime" 
			    					value="<fmt:formatDate value="${cggt.planFinishTime}" type="date" dateStyle="medium"/>"/>
		    				</td>
		    				<td>
		    					<input class="easyui-numberbox" maxlength="3" type="text" name="cggt.planDayNum"
		    						value="${cggt.planDayNum }" data-options="min:0,max:1000,precision:0"/>
		    				</td>
		    				<td>
		    			...
		    			<tr>
		    				...
		    				<td>
			    				...
			    				<input class="easyui-datebox" type="text" name="yjff.planFinishTime" 
			    					value="<fmt:formatDate value="${yjff.planFinishTime}" type="date" dateStyle="medium"/>"/>
		    				</td>
		    				<td>
		    					<input class="easyui-numberbox" maxlength="3" type="text" name="yjff.planDayNum"
		    						value="${yjff.planDayNum }" data-options="min:0,max:1000,precision:0"/>
		    				</td>
		    				<td>
		    			...
		    			<tr>
		    				...
		    				<td>
			    				...
			    				<input class="easyui-datebox" type="text" name="zp.planFinishTime" 
			    					value="<fmt:formatDate value="${zp.planFinishTime}" type="date" dateStyle="medium"/>"/>
		    				</td>
		    				<td>
		    					<input class="easyui-numberbox" maxlength="3" type="text" name="zp.planDayNum"
		    						value="${zp.planDayNum }" data-options="min:0,max:1000,precision:0"/>
		    				</td>
		    				<td>
		    			...
		    			<tr>
		    				...
		    				<td>
			    				...
			    				<input class="easyui-datebox" type="text" name="jy.planFinishTime" 
			    					value="<fmt:formatDate value="${jy.planFinishTime}" type="date" dateStyle="medium"/>"/>
		    				</td>
		    				<td>
		    					<input class="easyui-numberbox" maxlength="3" type="text" name="jy.planDayNum"
		    						value="${jy.planDayNum }" data-options="min:0,max:1000,precision:0"/>
		    				</td>
		    				<td>
		    			...
		    			<tr>
		    				...
		    				<td>
			    				...
			    				<input class="easyui-datebox" type="text" name="ts.planFinishTime" 
			    					value="<fmt:formatDate value="${ts.planFinishTime}" type="date" dateStyle="medium"/>"/>
		    				</td>
		    				<td>
		    					<input class="easyui-numberbox" maxlength="3" type="text" name="ts.planDayNum"
		    						value="${ts.planDayNum }" data-options="min:0,max:1000,precision:0"/>
		    				</td>
		    				<td>
		    	...
		    	<table class="tb_last" style="width: 93%;margin-top: 40px;">
	    			<tr>
	    				<td>出库时间</td>
	    				<td><input class="easyui-datebox" type="text" name="outDate" value="<fmt:formatDate value="${detailVo.outDate }" type="date" dateStyle="medium"/>" /></td>
	    				<td>直发件数量</td>
	    				<td><input type="text" class="easyui-numberbox" name="zfjNum" value="${detailVo.zfjNum }"/></td>
	    				
	    				<td>直发件已完成数量</td>
	    				<td><input type="text" class="easyui-numberbox" name="zfjFinishNum" value="${detailVo.zfjFinishNum }"/></td>
	    				
	    				<td>直发件最终完成日期</td>
	    				<td><input class="easyui-datebox" type="text" name="zfjFinishDate" value="<fmt:formatDate value="${detailVo.zfjFinishDate }" type="date" dateStyle="medium"/>" /></td>
	    				<td></td>
	    			</tr>
	    			<tr>
	    				<td>发货报告</td>
	    				<td colspan="2"><input class="easyui-textbox" name="deliveryReport" data-options="multiline:true" style="height: 100px;width: 80%;" value="${detailVo.deliveryReport }" /></td>
	    				
	    				<td>详细进度1</td>
	    				<td colspan="2">
	    					<input class="easyui-textbox" name="remark1" data-options="multiline:true" style="height:100px;width: 80%;" value="${detailVo.remark1 }" />
	    				</td>
	    				<td>详细进度2</td>
	    				<td colspan="2">
	    					<input class="easyui-textbox" name="remark2" data-options="multiline:true" style="height:100px;width: 80%;" value="${detailVo.remark2 }" />
	    				</td>
	    			</tr>
	    			<tr>
	    				<td>详情进度3</td>
	    				<td colspan="2"><input class="easyui-textbox" name="remark3" data-options="multiline:true" style="height:100px;width: 80%;" value="${detailVo.remark3 }" /></td>
	    				<td>详细进度4</td>
	    				<td colspan="2">
	    					<input class="easyui-textbox" name="remark4" data-options="multiline:true" style="height:100px;width: 80%;" value="${detailVo.remark4 }" />
	    				</td>
	    				<td>详细进度5</td>
	    				<td colspan="2">
	...
	$('#uploadFile').ajaxfileupload({
		...
		function delFile(id){
			...
			$.post("${basePath}/file/del/"+id,function(data){
				if(data.status == 200){
					 $("tr").remove("#file_"+id);
